...
Reemplazar TIMESTAMP, STATUS y N con los valores reales de cada fase de revisión.
STATUS es "clean" si no hay problemas sin resolver, "issues_open" en caso contrario.
