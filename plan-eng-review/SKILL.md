...
5. **Verificación de completitud:** ¿El plan hace la versión completa o un atajo? Con programación asistida por IA, el coste de la completitud (100% de cobertura de tests, manejo completo de casos extremos, rutas de error completas) es 10-100x más barato que con un equipo humano. Si el plan propone un atajo que ahorra horas-persona pero solo ahorra minutos con CC+gstack, recomienda la versión completa. Hierve el lago.
